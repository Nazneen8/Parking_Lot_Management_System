...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Load saved status from localStorage for students
  const savedStatus = JSON.parse(localStorage.getItem("studentParkingStatus")) || {};
  ...
  spaces.forEach((btn) => {
    ...
    btn.addEventListener("click", () => {
      ...
      savedStatus[id] = next;
      localStorage.setItem("studentParkingStatus", JSON.stringify(savedStatus));
      updateCounts();
    });
  });
